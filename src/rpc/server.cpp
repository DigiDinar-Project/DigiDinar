...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Digi Dinar server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Digi Dinar server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Digi Dinar features */
        {"digidinar", "masternode", &masternode, true, true, false},
        {"digidinar", "listmasternodes", &listmasternodes, true, true, false},
        {"digidinar", "getmasternodecount", &getmasternodecount, true, true, false},
        {"digidinar", "masternodeconnect", &masternodeconnect, true, true, false},
        {"digidinar", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"digidinar", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"digidinar", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"digidinar", "masternodecurrent", &masternodecurrent, true, true, false},
        {"digidinar", "masternodedebug", &masternodedebug, true, true, false},
        {"digidinar", "startmasternode", &startmasternode, true, true, false},
        {"digidinar", "createmasternodekey", &createmasternodekey, true, true, false},
        {"digidinar", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"digidinar", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"digidinar", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"digidinar", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"digidinar", "getmasternodescores", &getmasternodescores, true, true, false},
        {"digidinar", "mnbudget", &mnbudget, true, true, false},
        {"digidinar", "preparebudget", &preparebudget, true, true, false},
        {"digidinar", "submitbudget", &submitbudget, true, true, false},
        {"digidinar", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"digidinar", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"digidinar", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"digidinar", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"digidinar", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"digidinar", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"digidinar", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"digidinar", "checkbudgets", &checkbudgets, true, true, false},
        {"digidinar", "mnsync", &mnsync, true, true, false},
        {"digidinar", "spork", &spork, true, true, false},
        {"digidinar", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzddrseed", &getzddrseed, false, false, true},
        {"zerocoin", "setzddrseed", &setzddrseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzddr", &searchdzddr, false, false, true},
        {"zerocoin", "dzddrstate", &dzddrstate, false, false, true}
...
{
    return "> digidinar-cli " + methodname + " " + args + "\n";
}
