...
enum WalletFeature {
    ...
    FEATURE_PRE_DIGIDINAR = 61000, // inherited version..
...
enum ZerocoinSpendStatus {
    ...
    ZDDR_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
...
public:
    ...
    /// Get 10000 DDR output and keys which can be used for the Masternode
    ...
    // zDDR wallet
    CzDDRWallet* zwalletMain{nullptr};
    std::unique_ptr<CzDDRTracker> zddrTracker{nullptr};
    void setZWallet(CzDDRWallet* zwallet);
    CzDDRWallet* getZWallet();
