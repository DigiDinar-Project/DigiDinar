...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("04870b8a9e2339021a1830d1f7f4b3ead77c8a62a3df36e55d96589bee35cdf9ca5719160669892536d7298e25dc892106c1786f8aefa72151799f86e4214686fc") << OP_CHECKSIG;
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("0000099ee5abb388a0fa2ca1864cfee1cbe510ab0e9abacfed70c7a3d6d9203e"))
    (630, uint256S("9cf5b61600a1d8489b7295be8a12984104f533d2e0856ef00745168456eff215"))
    (7728, uint256S("bb1f0cd26f221e47effdedce06dbeeac8ab9692fee2ee3f83356ef5933fefac4"))
    (58009, uint256S("5444275d87e9eea98a743aec96589e19b82e15578faf18082a6edf8b31b06ffe"))
    ;
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1550792244, 2868175, 0x1e0ffff0, 5, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000099ee5abb388a0fa2ca1864cfee1cbe510ab0e9abacfed70c7a3d6d9203e"));
        assert(genesis.hashMerkleRoot == uint256S("0x355339996acc666194e66c4e7f0b151d3eef1ae7154970587f3a3295aab56a19"));

        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // DIGIDINAR starting difficulty is 1 / 2^12
        ...
        // spork keys
        consensus.strSporkPubKey = "047639742517259eca25085a46d37699beac997a7ae0e7f73c36f51919a538041ce5be3c528a9defa5213bfa228958f95ba2770947cc9b3483d73f4fd6d1b97589";
        ...
        consensus.height_start_InvalidUTXOsCheck = 9999999;
        consensus.height_start_MessSignaturesV2 = 338060;  // height_start_TimeProtoV2
        consensus.height_start_StakeModifierNewSelection = 0;
        consensus.height_start_StakeModifierV2 = 95000;   // Block v6: 0ef2556e40f3b9f6e02ce611b832e0bbfe7734a8ea751c7b555310ee49b61456
        consensus.height_start_TimeProtoV2 = 338060;       // Block v7: 14e477e597d24549cac5e59d97d32155e6ec2861c1003b42d0566f9bf39b65d5
        ...
        consensus.height_start_ZC_PublicSpends = 58700;
        consensus.height_start_ZC_SerialRangeCheck = 9999999;
        consensus.height_start_ZC_SerialsV2 = 20;
        consensus.height_ZC_RecalcAccumulators = 9999999;

        // validation by-pass
        consensus.nDigidinarBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nDigidinarBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.ZC_TimeStart = 1550792244;        // October 17, 2017 4:30:00 AM
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1547119740, 2908155, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x00000df3a564340ff158d6cc1190fe85ded6c129b3478a3e687cca4ff9e91fda"));
        ...
        // validation by-pass
        consensus.nDigidinarBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nDigidinarBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "digidinar-testnet.seed.fuzzbawls.pw", true));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "digidinar-testnet.seed2.fuzzbawls.pw", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet digidinar addresses start with 'x' or 'y'
        ...
        // Testnet digidinar BIP32 pubkeys start with 'DRKV'
...
public:
    CRegTestParams()
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x7ca3e82de950df19c22b5391ec18d16ffa3d2ba77bf5ee130324ba181d59d66b"));
        //assert(genesis.hashMerkleRoot == uint256S("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));
