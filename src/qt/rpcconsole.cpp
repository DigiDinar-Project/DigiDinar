                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDDRPathCustom = GetArg("-zddrbackuppath", "");
    ...
    if(!strzDDRPathCustom.empty()) {
        ui->wallet_customzddrbackuppath->setText(QString::fromStdString(strzDDRPathCustom));
        ui->wallet_customzddrbackuppath_label->setVisible(true);
        ui->wallet_customzddrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDDRPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DIGIDINAR RPC console.") + "<br>" +
