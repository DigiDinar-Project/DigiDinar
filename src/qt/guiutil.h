...
/** Utility functions used by the DIGIDINAR Qt UI.
 */
namespace GUIUtil
{
...
// Render DIGIDINAR addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZddr = false);
...
// Parse "digidinar:" URI into recipient object, return true on successful parsing
