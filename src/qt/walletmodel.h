...
#ifndef DIGIDINAR_QT_WALLETMODEL_H
#define DIGIDINAR_QT_WALLETMODEL_H
...
/** Interface to DIGIDINAR wallet from Qt view code. */
...
#endif // DIGIDINAR_QT_WALLETMODEL_H
