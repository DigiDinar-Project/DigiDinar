...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DIGIDINAR Core"),
     ...
     * override -datadir in the digidinar.conf file in the default data directory
     * (to be consistent with digidinard behavior)
     */
    if (dataDir != getDefaultDataDirectory())
