...
#include "qt/digidinar/sendcustomfeedialog.h"
#include "qt/digidinar/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(DIGIDINARGUI* parent, WalletModel* model) :
    QDialog(parent),
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &DIGIDINARGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
