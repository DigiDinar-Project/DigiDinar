...
#include "config/digidinar-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalDdr = 0;
    qint64 totalZddr = 0;
    QList<qreal> valuesDdr;
    QList<qreal> valueszDdr;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(DIGIDINARGUI* _window);
    ~DashboardWidget();
