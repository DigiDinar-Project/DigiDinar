...
#ifndef DIGIDINAR_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define DIGIDINAR_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //DIGIDINAR_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
