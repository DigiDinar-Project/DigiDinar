...
#include "qt/digidinar/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/digidinar/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(DIGIDINARGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://DIGIDINAR.org/");
    ...
    if (parent)
        connect(parent, &DIGIDINARGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
