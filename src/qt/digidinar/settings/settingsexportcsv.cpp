...
#include "qt/digidinar/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(DIGIDINARGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("DIGIDINAR_tx_csv_export(*.csv)") : tr("DIGIDINAR_addresses_csv_export(*.csv)"),
                                        nullptr);
