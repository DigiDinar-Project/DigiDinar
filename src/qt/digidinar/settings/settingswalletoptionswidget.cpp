...
#include "qt/digidinar/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/digidinar/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(DIGIDINARGUI* _window, QWidget *parent) :
