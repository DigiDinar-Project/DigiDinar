...
#include "qt/digidinar/settings/settingsnetworkwidget.h"
#include "qt/digidinar/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/digidinar/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(DIGIDINARGUI* _window, QWidget *parent) :
