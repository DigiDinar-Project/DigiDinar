...
#include "qt/digidinar/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(DIGIDINARGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &DIGIDINARGUI::openFAQ);
