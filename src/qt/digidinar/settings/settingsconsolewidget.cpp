...
#include "qt/digidinar/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/digidinar/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(DIGIDINARGUI* _window, QWidget *parent) :
