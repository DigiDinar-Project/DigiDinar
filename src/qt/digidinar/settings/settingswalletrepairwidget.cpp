...
#include "qt/digidinar/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/digidinar/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(DIGIDINARGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to DIGIDINARGUI::handleRestart()
