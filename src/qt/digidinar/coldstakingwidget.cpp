...
#include "qt/digidinar/coldstakingwidget.h"
#include "qt/digidinar/forms/ui_coldstakingwidget.h"
#include "qt/digidinar/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/digidinar/requestdialog.h"
#include "qt/digidinar/tooltipmenu.h"
#include "qt/digidinar/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(DIGIDINARGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your DDRs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept DDR delegation / Delegate DDR"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select DDR outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 DDR" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
