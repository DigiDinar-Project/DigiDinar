...
#include "qt/digidinar/forms/ui_masternodeswidget.h"

#include "qt/digidinar/qtutils.h"
#include "qt/digidinar/mnrow.h"
#include "qt/digidinar/mninfodialog.h"
#include "qt/digidinar/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(DIGIDINARGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 10000)) {
        inform(tr("Not enough balance to create a masternode, 10,000 DDR required."));
        return;
    }
    showHideOp(true);
