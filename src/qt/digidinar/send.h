...
#include "qt/digidinar/contactsdropdown.h"
#include "qt/digidinar/sendmultirow.h"
...
public:
    explicit SendWidget(DIGIDINARGUI* parent);
    ~SendWidget();
...
private Q_SLOTS:
    void onDDRSelected(bool _isDDR);
    void onSendClicked();
...
private:
    ...
    bool sendZddr(QList<SendCoinsRecipient> recipients);
