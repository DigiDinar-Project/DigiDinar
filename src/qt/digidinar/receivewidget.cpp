...
#include "qt/digidinar/forms/ui_receivewidget.h"
...
#include "qt/digidinar/addressholder.h"
...
ReceiveWidget::ReceiveWidget(DIGIDINARGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive DDR."));
