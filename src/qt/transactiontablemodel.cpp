...
// Copyright (c) 2016-2019 The DIGIDINAR developers
...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted DDR to zDDR");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zDDR");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received DDR from zDDR");
    case TransactionRecord::ZerocoinSpend_Change_zDdr:
        return tr("Minted Change as zDDR from zDDR Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zDDR to DDR");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zDdr:
        return tr("Anonymous (zDDR Transaction)");
    case TransactionRecord::StakeZDDR:
        return tr("Anonymous (zDDR Stake)");
    case TransactionRecord::SendToSelf:
    default:
...
QVariant TransactionTableModel::data(const QModelIndex& index, int role) const
{
    ...
    case Qt::ForegroundRole:
        ...
        if (rec->type == TransactionRecord::Generated || rec->type == TransactionRecord::StakeMint ||
                rec->type == TransactionRecord::StakeZDDR || rec->type == TransactionRecord::MNReward) {
