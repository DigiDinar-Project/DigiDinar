...
public:
    ...
    void setZDdrControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzDDR_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzDDR_clicked();
    void on_pushButtonZDdrControl_clicked();
