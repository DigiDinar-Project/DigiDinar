Contributing to DIGIDINAR Core
============================

The DIGIDINAR Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/digidinar-project/digidinar/blob/master/doc/translation_process.md)
...
The following applies to code changes to the DIGIDINAR Core project, and is not to be
confused with overall DIGIDINAR Network Protocol consensus changes.

Whether a pull request is merged into DIGIDINAR Core rests with the project merge
...
Patches that change DIGIDINAR consensus rules are considerably more involved than
...
Where a patchset proposes to change the DIGIDINAR consensus, it must have been
...
The project leader is the release manager for each DIGIDINAR Core release.
