UNIX BUILD NOTES
====================
Some notes on how to build DigiDinar in Unix.

Note
---------------------
Always use absolute paths to configure and compile digidinar and the dependencies,
...
# Pick some path to install BDB to, here we create a directory within the digidinar directory
BDB_PREFIX="${DigiDinar_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
Security
--------
To help make your DigiDinar installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, digidinar should be built with a non-executable stack
