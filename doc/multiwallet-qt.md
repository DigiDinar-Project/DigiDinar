...
In order to support loading of multiple wallets in digidinar-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is digidinar.cpp.
...
Changes to digidinar.cpp
----------------------
digidinar.cpp is the entry point into digidinar-qt, and as such, will require some minor modifications to provide hooks for
