DIGIDINAR Core version *3.3.0* is now available from:  <https://github.com/digidinar-project/digidinar/releases>
...
### Core
 ...
 - #891 `855408c2c3` [ZDDR] Zerocoin public coin spend. (furszy)
 - #897 `65bd788945` [zDDR] Disable zerocoin minting (random-zebra)
 - #899 `4b22a09024` [zDDR] Disable zDDR staking (random-zebra)
...
### Miscellaneous
 ...
 - #904 `6f597629d8` [zDDR] Free memory from ToString() (warrows)
 - #912 `5f167c2c7e` [Cleanup] compiler warnings in coinSpend object. (furszy)
 - #919 `c0233e4af6` [zDDR] Debug missing jump line. (Matias Furszyfer)
