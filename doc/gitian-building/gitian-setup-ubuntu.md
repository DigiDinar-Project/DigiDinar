...
The build script we'll be using is contained in the DIGIDINAR github repository ([contrib/gitian-build.py](https://github.com/digidinar-project/digidinar/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the DIGIDINAR repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/DIGIDINAR-Project/DIGIDINAR/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, digidinar-detached-sigs, and digidinar GitHub repos.
