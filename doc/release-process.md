...
- Detached signatures will then be committed to the [digidinar-detached-sigs](https://github.com/PIVX-Project/digidinar-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
