...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/DigiDinar-Project/DigiDinar/blob/master/doc/translation_process.md#synchronising-translations).
...
### DigiDinar maintainers/release engineers, suggestion for writing release notes
...
### Build and sign PIVX Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit digidinar=v${VERSION} ../digidinar/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit digidinar=v${VERSION} ../digidinar/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit digidinar=v${VERSION} ../digidinar/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit digidinar=v${VERSION} ../digidinar/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-aarch64 --destination ../gitian.sigs/ ../digidinar/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/digidinar-*.tar.gz build/out/src/digidinar-*.tar.gz ../
    popd
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`digidinar-${VERSION}-osx-unsigned.dmg`, `digidinar-${VERSION}-osx64.tar.gz`)
...
Verify the signatures
    ...
    ./bin/gverify -v -d ../gitian.sigs/ -r ${VERSION}-aarch64 ../digidinar/contrib/gitian-descriptors/gitian-aarch64.yml
    popd
...
Codesigner only: Sign the osx binary:
    ...
    transfer digidinar-osx-unsigned.tar.gz to osx for signing
...
space *do not upload these to the digidinar.org server*.
