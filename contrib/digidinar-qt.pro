...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/digidinar-cli.cpp \
           src/digidinar-tx.cpp \
           src/digidinar.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/digidinar.qrc src/qt/digidinar_locale.qrc

TRANSLATIONS += src/qt/locale/digidinar_bg.ts \
                src/qt/locale/digidinar_de.ts \
                src/qt/locale/digidinar_en.ts \
                src/qt/locale/digidinar_es.ts \
                src/qt/locale/digidinar_fi.ts \
                src/qt/locale/digidinar_fr.ts \
                src/qt/locale/digidinar_it.ts \
                src/qt/locale/digidinar_ja.ts \
                src/qt/locale/digidinar_pl.ts \
                src/qt/locale/digidinar_pt.ts \
                src/qt/locale/digidinar_ru.ts \
                src/qt/locale/digidinar_sk.ts \
                src/qt/locale/digidinar_sv.ts \
                src/qt/locale/digidinar_vi.ts \
                src/qt/locale/digidinar_zh_CN.ts \
                src/qt/locale/digidinar_zh_TW.ts
