...
from test_framework.digidinar_node import DigidinarTestNode
...
class DIGIDINAR_ColdStakingTest(DigidinarTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(DigidinarTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 DDR from the pot)
...
if __name__ == '__main__':
    DIGIDINAR_ColdStakingTest().main()
