...
"""Verify that starting digidinar with -h works as expected."""
import subprocess

from test_framework.test_framework import DigidinarTestFramework
from test_framework.util import assert_equal

class HelpTest(DigidinarTestFramework):
    ...
    def run_test(self):
        self.log.info("Start digidinar with -h for help text")
        ...
        self.log.info("Start digidinar with -version for version information")
